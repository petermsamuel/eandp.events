...
const Blog = () => {
  ...
  const blogLd = {
    ...
    mainEntity: blogPosts.map((p) => ({
      "@type": "BlogPosting",
      headline: p.title,
      url: toAbsolute(p.href),
      image: toAbsolute(stripQuery(p.image)),
  ...
  return (
    <>
      <Helmet>
        ...
        {/* Preload the hero for faster LCP */}
        ...
        <meta
          ...
          content="Read tips, stories, and expert advice from Atlanta’s leading wedding and corporate event planners."
        />
        {/* Use hero as social image so it never 404s */}
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-white mb-6">
              Tips, behind-the-scenes insights, and expert advice from Atlanta’s
              trusted planners. Whether you're organizing a luxury wedding or a
              high-impact corporate event, our blog helps you plan smarter and
              stress less.
            </p>
          </div>
        ...
        <section id="blog-posts" className="py-20 px-4 bg-[#f8f6ed]">
          <div className="max-w-6xl mx-auto mb-12 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Stories, insights, and practical advice for anyone planning a
              wedding or corporate event in Atlanta—and far beyond.
            </p>
          </div>
