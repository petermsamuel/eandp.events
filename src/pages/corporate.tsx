        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Experts in South Asian wedding planning, fusion weddings, corporate events, and more.<br /><br />
              Based in Atlanta, trusted across Georgia and beyond.
            </p>
            <div className="mt-4 flex items-center space-x-4">
              <a href="https://www.facebook.com/eventsep/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-gold transition-colors"><Facebook size={24} /></a>
              <a href="https://www.instagram.com/eandp_events/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-gold transition-colors"><Instagram size={24} /></a>
              <a href="mailto:info@eandp.events" className="text-gray-300 hover:text-gold transition-colors"><Mail size={24} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#what-we-do" className="text-gray-300 hover:text-gold transition-colors">What We Do</a></li>
              <li><a href="#how-it-works" className="text-gray-300 hover:text-gold transition-colors">How It Works</a></li>
              <li><a href="#testimonial" className="text-gray-300 hover:text-gold transition-colors">Testimonials</a></li>
              <li><a href="#partners" className="text-gray-300 hover:text-gold transition-colors">Partners</a></li>
              <li><a href="#cta" className="text-gray-300 hover:text-gold transition-colors">Contact</a></li>
            </ul>
          </div>

          <div>
            <h3 className="text-xl font-bold mb-4">Contact</h3>
            <p className="text-gray-300 mb-2">Email: <a href="mailto:info@eandp.events" className="text-gold hover:underline">info@eandp.events</a></p>
      ...
      <div className="min-h-screen bg-transparent flex flex-col">
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl text-center mx-auto">
            ...
            <div className="flex justify-center">
              <a href="#cta" className="btn btn-primary bg-navy text-white text-lg sm:text-base rounded-full px-6 py-3">
        ...
        <section id="what-we-do" className="py-20 px-6 md:px-12 lg:px-16 bg-[#2a2a2a]">
          <div className="text-center mb-16 text-white">
            <h2 className="section-title">What You Need, What We Deliver</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[["Tight timelines?", "Delivered."], ["Global audiences?", "Understood."], ["Deadline meltdowns?", "Handled."]].map(([title, desc], i) => (
              <div key={i} className="flex flex-col items-center text-center p-6 bg-white shadow-sm rounded-lg">
                <div className="h-14 w-14 bg-[#f5f1ea] rounded-full flex items-center justify-center mb-4">
                  {[Check, Globe, Users][i]({ className: "h-7 w-7 text-gold" })}
                </div>
                <h3 className="text-xl font-semibold mb-2 text-[#2a2a3a]">{title}</h3>
                <p className="text-lg text-[#7b6535]">{desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* How It Works */}
        <section id="how-it-works" className="py-20 px-6 md:px-12 lg:px-16 bg-transparent">
