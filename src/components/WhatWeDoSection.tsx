...
const WhatWeDoSection = () => {
  return (
    <section
      id="what-we-do"
      className="relative z-10 section-container bg-white/80 backdrop-blur-sm py-20"
    >
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4">
        ...
        <a
          href="/corporate.html"
          className="bg-white/80 backdrop-blur-md p-8 rounded-md border border-gray-100 hover:shadow-lg transition-shadow"
        >
